					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Quizz mensuelle</span>
							</a>
							<ul class="submenu">
								<li><a href="form-basic.html">Add</a></li>
								<li>
									<a href="advanced-components.html">List</a>
								</li>
								<li><a href="form-wizard.html">Search</a></li>
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Result Quizz</span>
							</a>
							<ul class="submenu">
								<li><a href="basic-table.html">List</a></li>
								<li><a href="datatable.html">Search</a></li>
							</ul>
						</li>
						<!--<li>
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext"> Quizz Recrutement </span>
							</a>
							<ul class="submenu">
								<li><a href="ui-buttons.html">List</a></li>
								<li><a href="ui-cards.html">Result</a></li>
								<li><a href="ui-cards-hover.html">Search</a></li>
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Evaluation stagiaire</span>
							</a>
							<ul class="submenu">
								<li><a href="bootstrap-icon.html">List</a></li>
								<li><a href="font-awesome.html">Result</a></li>
								<li><a href="foundation.html">Search</a></li>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="highchart.html">Charts</a></li>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="video-player.html">Add</a></li>
						...
						<li>
							...
							>
								...
								<span class="mtext"
									>Landing Page
									<img src="{{asset('deskapp/vendors/images/coming-soon.png')}}" alt="" width="25"
								/></span>
							</a>
						</li>
					    -->
