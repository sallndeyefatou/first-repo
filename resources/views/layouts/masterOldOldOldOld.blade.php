			...
			<div class="header-right">
				...
				<div class="github-link">
					<a href="https://github.com/dropways/deskapp" target="_blank"
						><img src="{{asset('deskapp/vendors/images/github.svg')}}" alt=""
					/></a>
				</div>
			</div>
		</div>
					...
					<table class="data-table table nowrap">
						...
						<tbody>
							...
							<tr>
								<td class="table-plus">
									<img
										src="{{asset('deskapp/vendors/images/product-2.jpg')}}"
										width="70"
										height="70"
										alt=""
									/>
							...
							<tr>
								<td class="table-plus">
									<img
										src="{{asset('deskapp/vendors/images/product-3.jpg')}}"
										width="70"
										height="70"
										alt=""
									/>
							...
							<tr>
								<td class="table-plus">
									<img
										src="{{asset('deskapp/vendors/images/product-4.jpg')}}"
										width="70"
										height="70"
										alt=""
									/>
							...
							<tr>
								<td class="table-plus">
									<img
										src="{{asset('deskapp/vendors/images/product-5.jpg')}}"
										width="70"
										height="70"
										alt=""
									/>
